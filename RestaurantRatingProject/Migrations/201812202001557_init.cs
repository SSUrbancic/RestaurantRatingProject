namespace RestaurantRatingProject.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CriticID = c.Int(nullable: false),
                        RestaurantID = c.Int(nullable: false),
                        StarRating = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ReviewID)
                .ForeignKey("dbo.Critics", t => t.CriticID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reviews", "CriticID", "dbo.Critics");
            ...
            DropIndex("dbo.Reviews", new[] { "CriticID" });
